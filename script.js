...
window.onload = function() {
    $("#ol").html(`<center><div id="inst"><h3>Hey!</h3><b>Instructions For Game:</b><br/><br/><li>Make similiar pairs of blocks by flipping them.</li><li>To flip, click on a block.</li><li>If two blocks unsimilar blocks will come, they will be flipped back.</li><p style="font-size:18px;">Click any one mode to begin the game.</p><p>Let's Start!!</p></div><button onclick="start(3, 4)">3 x 4</button> <button onclick="start(4, 4)" style="w">4 x 4</button><button onclick="start(4, 5)">4 x 5</button><button onclick="start(5, 6)">5 x 6</button><button onclick="start(6, 6)">6 x 6</button></center>`);
}
